...
- 2026年1月4日06:22:18，V3.6.30，规范了流的使用，划分了Device子类的实现源文件，修复了NCCL的bug。CPU与GPU之间、多GPU之间的通信问题基本上完全解决，Host-to-Device传输速率10GB/s以上，All-Reduce和Broadcast速率30GB/s以上，全部达到实用标准。
- 2026年1月5日13:00:05，Python脚本实现了MNIST、CIFAR-10、CIFAR-100、ImageNet数据集的全自动下载、验证、解压、整理，为导出.dts格式打好基础
- 2026年1月6日16:11:29，成功生成第一个.dts文件！
- 2026年1月7日06:52:09，成功生成了LV0（无损）的imagenet_train.dts和imagenet_val.dts！
- 2026年1月8日18:07:55，实现了MNIST、CIFAR-10、CIFAR-100、ImageNet（LV0/LV1/LV2/LV3）的.dts导出！
- 2026年1月9日16:16:31，成功使用框架加载LV0压缩级别的ImageNet训练集（137GB），平均用时仅**40.82s**！我们的最终演示的目标是每epoch用时53s以内，40.82s的加载用时意味着数据加载将不再是性能瓶颈！
- 2026年1月10日06:31:18，成功导出了完整的ImageNet LV3数据集，训练集44.5GB、验证集1.92GB。
