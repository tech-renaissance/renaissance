...
print("=" * 60)
print("NEW RESULTS - Validation Set (50000 samples)")
print("=" * 60)

val_official_md5 = calc_md5('R:/renaissance/new_results/official_val_sorted.txt')
val_fully_md5 = calc_md5('R:/renaissance/new_results/fully_val.csv')
val_partial_md5 = calc_md5('R:/renaissance/new_results/partial_val.csv')
...
print()
print("=" * 60)
print("NEW RESULTS - Training Set (1281167 samples)")
print("=" * 60)

train_official_md5 = calc_md5('R:/renaissance/new_results/official_train_sorted.txt')
train_fully_md5 = calc_md5('R:/renaissance/new_results/fully_train.csv')
train_partial_md5 = calc_md5('R:/renaissance/new_results/partial_train.csv')
...
elif val_fully_ok and train_fully_ok and not val_partial_ok and train_partial_ok:
    print("FULLY correct, PARTIAL train correct, but PARTIAL val STILL WRONG")
else:
