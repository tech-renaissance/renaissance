/**
 * @file test_fully_mode.cpp
 * @brief FULLY模式完整性和速度测试
 * @details 测试V4.0新架构的FULLY模式，验证数据完整性和加载速度
 * @version 4.0.0
 * @date 2026-01-23
 * @author 技术觉醒团队
 */
...
void print_usage(const char* program_name) {
    std::cout << "Usage: " << program_name << " [OPTIONS]\n\n"
              ...
              << "  " << program_name << " --dts --path /data/imagenet --val --lv 0 --workers 16\n"
...
void print_results(double time_sec, size_t total_samples,
    ...
    std::cout << "\n========================================\n"
              << "FULLY Mode Test Results: " << dataset_name << "\n"
              << "========================================\n"
...
int main(int argc, char** argv) {
    ...
    std::cout << "========================================\n"
              << "FULLY Mode Test: " << (is_train ? "Training" : "Validation") << " Set\n"
              << "========================================\n"
              << "DTS file:       " << dts_file << "\n"
