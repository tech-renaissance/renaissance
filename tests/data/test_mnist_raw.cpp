/**
 * @file test_mnist_raw.cpp
 * @brief MNIST RAW Loader测试
 * @details 测试MNIST RAW数据加载器的完整性和性能
 * @version 1.0.0
 * @date 2026-02-01
 * @author 技术觉醒团队
 */
...
void print_usage(const char* program_name) {
    std::cout << "Usage: " << program_name << " [OPTIONS]\n\n"
              ...
              << "Examples:\n"
              << "  " << program_name << " --path T:/dataset/mnist --train\n"
              << "  " << program_name << " --path T:/dataset/mnist --val\n"
              << "  " << program_name << " --path T:/dataset/mnist --train --preprocess 32\n";
}
