/**
 * @file test_raw_partial_mode.cpp
 * @brief RAW Loader PARTIAL模式完整性和速度测试
 * @details 测试ImageNetLoaderRaw的PARTIAL模式，验证数据完整性和加载速度
 * @version 1.0.0
 * @date 2026-01-31
 * @author 技术觉醒团队
 */
...
void print_usage(const char* program_name) {
    std::cout << "Usage: " << program_name << " [OPTIONS]\n\n"
              ...
              << "  " << program_name << " --path /data/imagenet --train --workers 16\n"
...
void print_results(double time_sec, size_t total_samples,
    ...
    std::cout << "\n========================================\n"
              << "RAW PARTIAL Mode Test Results: " << dataset_name << "\n"
              << "========================================\n"
...
int main(int argc, char** argv) {
    ...
    std::cout << "========================================\n"
              << "RAW PARTIAL Mode Test: " << (is_train ? "Training" : "Validation") << " Set\n"
              << "========================================\n"
    ...
    try {
        ...
        std::cout << "      For cold cache performance, use --clear-cache flag." << std::endl;
