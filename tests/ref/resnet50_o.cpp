/**
 * @file resnet50_o.cpp
 * @brief ResNet-50 training under MLPerf Open Division rules
 * @version 4.20.1
 * @date 2026-06-28
 * @author 技术觉醒团队
 * @note 所属系列: tests/ref
...
int main() {
    ...
    PREPROCESSOR_SETTING
        ...
        .train_transforms(
            FastRandomResizedCrop(224, {0.25f, 1.0f}, {0.75f, 1.333f}),
            RandomHorizontalFlip(),
            RandomErasing(0.5f, {0.05f, 0.4f}, {0.3f, 3.3f}))
        .val_transforms(
            Resize(256),
            CenterCrop(224))
        .commit();
    ...
    task.model(resnet50)
        ...
        .save_best_model("resnet50_open_division.mdl");
    ...
    std::cout << "\n=====================================================\n"
              << " Tech-Renaissance ResNet-50 (MLPerf Open Division)\n"
              << "-----------------------------------------------------\n"
