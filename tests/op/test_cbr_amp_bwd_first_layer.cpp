...
int main(int argc, char** argv) {
    ...
    auto run = [&](const char* label) {
        ...
        DTensor d_gw_cbr    = task.alloc(w_shape, DType::FP16, Region::G_FIRST_CONV_FP16);
        ...
        DTensor d_gw_sep    = task.alloc(w_shape, DType::FP16, Region::G_FIRST_CONV_FP16);
        ...
        g_sep.append(ComputeOp::BN2D_AMP_BWD,
            ...
            OpParams{bn_p});
        g_sep.append(ComputeOp::CONV_AMP_BWD_FIRST_LAYER,
