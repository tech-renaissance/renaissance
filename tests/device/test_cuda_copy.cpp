...
int main() {
    std::cout << "========================================" << std::endl;
    std::cout << "  CUDA Tensor Copy Performance Test" << std::endl;
    std::cout << "========================================" << std::endl;
    ...
    try {
        ...
        Tensor tensor_a = cuda.randn(shape, 0.0f, 1.0f, DType::FP32);
        ...
        cuda.copy_into(tensor_a, tensor_b);
        ...
        bool equal = cuda.is_close(tensor_a, tensor_b);
