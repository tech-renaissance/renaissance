...
int main() {
    std::cout << "========================================" << std::endl;
    std::cout << "  MUSA Tensor Copy Performance Test" << std::endl;
    std::cout << "========================================" << std::endl;
    ...
    try {
        ...
        Tensor tensor_a = musa.randn(shape, 0.0f, 1.0f, DType::FP32);
        ...
        Tensor tensor_b = musa.zeros(shape, DType::FP32);
        ...
        bool equal = musa.is_close(tensor_a, tensor_b);
