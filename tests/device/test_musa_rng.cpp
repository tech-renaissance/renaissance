/**
 * @file test_musa_rng.cpp
 * @brief MUSA随机数生成器测试（CPU/GPU结果一致性验证）
 * @version 3.6.8
 * @date 2025-12-27
 * @author 技术觉醒团队
 */
...
void test_cpu_gpu_consistency() {
    ...
    // 测试正态分布FP32（最重要）
    {
        ...
        musaMemcpy(gpu_data.data(), gpu_tensor.data_ptr(),
                   count * sizeof(float), musaMemcpyDeviceToHost);
    ...
    // 测试均匀分布INT32
    {
        ...
        musaMemcpy(gpu_data.data(), gpu_tensor.data_ptr(),
                   count * sizeof(int32_t), musaMemcpyDeviceToHost);
    ...
    // 测试伯努利INT8
    {
        ...
        musaMemcpy(gpu_data.data(), gpu_tensor.data_ptr(),
                   count * sizeof(int8_t), musaMemcpyDeviceToHost);
...
int main() {
    std::cout << "========================================" << std::endl;
    std::cout << "  MUSA RNG Test Suite" << std::endl;
    std::cout << "========================================" << std::endl;
    ...
    try {
        ...
        std::cout << "\n========================================" << std::endl;
        std::cout << "  All MUSA RNG tests passed!" << std::endl;
        std::cout << "========================================" << std::endl;
