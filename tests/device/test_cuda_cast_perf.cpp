...
int main() {
    ...
    try {
        ...
        Timer timer;
        cuda.cast_into(fp32_gpu, bf16_gpu, TR_TRANSFER_STREAM);
        ...
        timer.reset();
        cuda.trunc_cast_into(fp32_gpu, bf16_gpu, TR_TRANSFER_STREAM);
        cuda.sync(TR_TRANSFER_STREAM);
        ...
        timer.reset();
        cuda.cast_into(bf16_gpu, fp32_gpu, TR_TRANSFER_STREAM);
        cuda.sync(TR_TRANSFER_STREAM);
        ...
        timer.reset();
        cuda.cast_into(int32_gpu, fp32_gpu, TR_TRANSFER_STREAM);
        cuda.sync(TR_TRANSFER_STREAM);
        ...
        timer.reset();
        cuda.cast_into(fp32_gpu, int32_gpu, TR_TRANSFER_STREAM);
        cuda.sync(TR_TRANSFER_STREAM);
        ...
        timer.reset();
        cuda.cast_into(int32_gpu, int8_gpu, TR_TRANSFER_STREAM);
        cuda.sync(TR_TRANSFER_STREAM);
        ...
        timer.reset();
        cuda.cast_into(int8_gpu, int32_gpu, TR_TRANSFER_STREAM);
        cuda.sync(TR_TRANSFER_STREAM);
        ...
        timer.reset();
        cuda.cast_into(int8_gpu, fp32_gpu, TR_TRANSFER_STREAM);
        cuda.sync(TR_TRANSFER_STREAM);
