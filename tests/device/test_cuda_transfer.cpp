...
int main() {
    ...
    try {
        ...
        // 性能测试阶段：3次迭代取平均值
        // ==============================================
        std::cout << "\n[3/6] CPU -> CUDA Transfer Benchmark (3 iterations)..." << std::endl;
        ...
        // CUDA → CPU 传输
        std::cout << "\n[4/6] CUDA -> CPU Transfer Benchmark (3 iterations)..." << std::endl;
        ...
        std::cout << "  CPU -> CUDA throughput (avg): " << std::setprecision(2) << throughput3_gb_s << " GB/s" << std::endl;
        std::cout << "  CUDA -> CPU throughput (avg): " << std::setprecision(2) << throughput4_gb_s << " GB/s" << std::endl;
