/**
 * @file test_musa_cast_perf.cpp
 * @brief MUSA数据类型转换性能测试
 * @version 3.6.18
 * @date 2026-01-03
 * @author 技术觉醒团队
 */
...
int main() {
    std::cout << "========================================" << std::endl;
    std::cout << "  MUSA Cast Performance Test (V3.6.18)" << std::endl;
    std::cout << "========================================" << std::endl;
    ...
    try {
        ...
        Tensor fp32_gpu = musa.empty(shape, DType::FP32);
        ...
        Tensor bf16_gpu = musa.zeros(shape, DType::BF16);
        ...
        Tensor int32_gpu = musa.empty(shape, DType::INT32);
        ...
        Tensor int8_gpu = musa.zeros(shape, DType::INT8);
        ...
        // 打印汇总
        std::cout << "\n========================================" << std::endl;
        std::cout << "  Performance Summary (MUSA)" << std::endl;
        std::cout << "========================================" << std::endl;
