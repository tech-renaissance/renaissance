/**
 * @file mlp_dual_maxpool.cpp
 * @brief MLP双MaxPool结构测试
 * @version 4.20.1
 * @date 2026-06-28
 * @author 技术觉醒团队
...
int main(int argc, char** argv) {
    ...
    BluePrint ultimate_mlp = seq(
        maxpool(3, 2, 1),                   // MaxPool: kernel_size=3, stride=2, padding=1
        maxpool(2, 2, 0),                   // MaxPool: kernel_size=2, stride=2, padding=0
        fc(512, true),                      // 中间层递减
