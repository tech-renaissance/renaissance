/**
 * @file musa_rng_kernels.cu
 * @brief MUSA随机数生成kernels实现
...
musaError_t launch_philox_uint64_kernel(
    ...
    philox_uint64_kernel<<<grid_size, block_size, 0, musaStreamDefault>>>(
...
musaError_t launch_philox_bernoulli_int8_kernel(
    ...
    philox_bernoulli_int8_kernel<<<grid_size, block_size, 0, musaStreamDefault>>>(
...
musaError_t launch_philox_uniform_int8_kernel(
    ...
    philox_uniform_int8_kernel<<<grid_size, block_size, 0, musaStreamDefault>>>(
...
musaError_t launch_philox_bernoulli_int32_kernel(
    ...
    philox_bernoulli_int32_kernel<<<grid_size, block_size, 0, musaStreamDefault>>>(
        n, seed, base_offset, prob_one, out
    );
...
musaError_t launch_philox_uniform_int32_kernel(
    ...
    philox_uniform_int32_kernel<<<grid_size, block_size, 0, musaStreamDefault>>>(
        n, seed, base_offset, low, high, out
    );
...
musaError_t launch_philox_uniform_float_kernel(
    ...
    philox_uniform_float_kernel<<<grid_size, block_size, 0, musaStreamDefault>>>(
        n, seed, base_offset, low, high, out
    );
...
musaError_t launch_philox_normal_float_kernel(
    ...
    philox_normal_float_kernel<<<grid_size, block_size, 0, musaStreamDefault>>>(
