...
## 1000个epoch（TRAIN+VAL）的总时间

|             | PARTIAL  |  FULLY  |
| :---------: | :------: | :-----: |
|   **RAW**   | 4377.384 | 340.045 |
| **DTS LV0** | 3650.975 | 344.570 |
| **DTS LV1** | 1888.034 | 340.486 |
| **DTS LV2** | 1912.179 | 335.207 |
| **DTS LV3** | 1548.642 | 333.137 |



## 特殊情形下的DTS优势

以下是在笔记本电脑（Intel Core i9-14900HX，8GB，Windows）上测得的数据
